...
def generation(markov_text, tables_df, clear_images_df, text_images_df, diagrams_df, schemes_df, logos_df, icons_df):
...
if __name__ == "__main__":
    ...
    generation(markov_text, tables_df, clear_images_df, text_images_df, diagrams_df, schemes_df, logos_df, icons_df)
